...
(function (App) {
    (function (Models) {
        ...
        var APBDes = (function (_super) {
            ...
            APBDes.CreateInputException = function (index, field, message) {
                var res = $.ajax(APBDes.ajaxSettings.build({
                    type: 'GET',
            ...
            APBDes.UpdateSources = function (uploader) {
        ...
        var APBDFile = (function (_super) {
            ...
            APBDFile.PostFile = function (uploader) {
        ...
        var FieldReport = (function (_super) {
            ...
            FieldReport.AddFieldReport = function (uploader) {
        ...
        var Transaction = (function (_super) {
            ...
            Transaction.AddTransferTransaction = function (uploader) {
